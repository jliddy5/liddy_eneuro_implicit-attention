...
% figure3.m
% ==============================================================================
% Purpose: Reproduce Figure 3 from Liddy et al. (2026, eNeuro).
%          Bayesian analysis of RSVP accuracy for the DT group across
...
DataTable = DataTable(DataTable.Group == "DT",:);
...
post_draws(post_draws.group == "DTF", :) = [];
...
% Save figure
exportgraphics(f, fullfile("figures", "figure3.tif"), 'Resolution', 600);
