# ==============================================================================
# correlations_exp1_exp2.R
# ==============================================================================
# Purpose: Bayesian correlations between RSVP accuracy and hand angle for the
#          DT and DTF groups combined (Experiments 1 and 2). Models four
#          pairwise correlations using bivariate Gaussian models with estimated
